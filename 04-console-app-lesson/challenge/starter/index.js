...
// Initializations /Default variable declaration
...
alert("Welcome to Challenge 4 - Console Finances Challenge!");

alert("This program is will generate an output from the raw data provided.\nThe output will be displayed as an Alert and can be viewed in the console log!");
